var WebCom_Components_SocialMediaShare_Template_IconOnly_Small = {
  ...
  + '<a class="socialmediashare_google_icon_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_icon_img"></a>'	
...
var WebCom_Components_SocialMediaShare_Template_IconOnly_Medium = {
    ...
    + '<a class="socialmediashare_google_icon_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_icon_medium_img"></a>'  
...
var WebCom_Components_SocialMediaShare_Template_IconOnly_Badge = {
  getMarkupText : function(component, formattingValues) {
    ...
    + '<a class="socialmediashare_google_badge_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_badge_img"></a>'		
...
var WebCom_Components_SocialMediaShare_Template_IconOnly_Large = {
  getMarkupText : function(component, formattingValues) {
    ...
    + '<a class="socialmediashare_google_iconunder_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_iconunder_img"></a>'		
...
var WebCom_Components_SocialMediaShare_Template_RoundedIconOnly_Large = {
	  getMarkupText : function(component, formattingValues) {
		...
		return '<div class="sms_container socialmediashare_icon_only_large">'
				...
				+ '<a class="socialmediashare_google_rounded_iconunder_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_rounded_iconunder_img socialmediashare_google_rounded_iconunder_img"></a>'
...
var WebCom_Components_SocialMediaShare_Template_IconRight  = {
    ...
    + '<a class="socialmediashare_google_icon_right_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_icon_right_img"></a>'
...
var WebCom_Components_SocialMediaShare_Template_IconSlant  = {
    ...
    + '<a class="socialmediashare_google_iconslant_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_iconslant_img"></a>'		
...
var WebCom_Components_SocialMediaShare_Template_IconSlantMini  = {
    getMarkupText : function(component, formattingValues)  {
      ...
      + '<a class="socialmediashare_google_iconslantmini_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_iconslantmini_img"></a>'    
  ...
  var WebCom_Components_SocialMediaShare_Template_IconUnder_Medium  = {
    getMarkupText : function(component, formattingValues)  {
      ...
      + '<a class="socialmediashare_google_iconunder_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_icon_medium_img"></a>'    
...
var WebCom_Components_SocialMediaShare_Template_IconIn  = {
	getMarkupText : function(component, formattingValues)  {
      ...
      + '        <a class="socialmediashare_google_iconin_a" href="${googleShareUrl}" ${target}><img src="'+WebCom.ResourceLoader.SHARED_URL+'/javascript/com/web/components/socialmediashare/1.1/images/placeholder.png" alt="Google Icon" class="socialmediashare_google_iconin_img"></a>'      
